...
DEPRECATED COPY: ใช้ไฟล์ตัวจริงที่นี่แทน

- Canonical: [crypto-tools/SKILL.md](file:///home/kali/Desktop/RTAF-CTF-2026/skill/ctf-arsenal/.agents/skills/crypto-tools/SKILL.md)
