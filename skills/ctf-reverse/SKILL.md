...
- [anti-analysis-ctf.md](anti-analysis-ctf.md) - Upstream anti-analysis bypass notes for CTF workflows
- [field-notes.md](field-notes.md) - Upstream quick RE notes and recurring challenge signatures
- [languages-platforms.md](languages-platforms.md) - Upstream platform-oriented language reversing notes
- [patterns-ctf-3.md](patterns-ctf-3.md) - Upstream CTF reverse pattern extension set
- [patterns-runtime.md](patterns-runtime.md) - Upstream runtime behavior pattern references
- [platforms-hardware.md](platforms-hardware.md) - Upstream hardware/platform RE references
- [tools-advanced-2.md](tools-advanced-2.md) - Upstream advanced tooling add-on
- [tools-emulation.md](tools-emulation.md) - Upstream emulation-focused reversing references
